...
5. Build [riscv-gnu-toolchain](https://github.com/riscv/riscv-gnu-toolchain).
   ...
   Deafult compilation configuration is RV64GC - all operations, 64bit and 32 bit and compressed instructions support. 
   To compile RV32G - all operations, 32bit and without compressed instrucitons: 
   Configure the toolchain with ```--with-arch=rv32g --disable-multilib``` to remove support of compressed instructions.
