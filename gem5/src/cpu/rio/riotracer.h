...
public:
	stageInfo(pipe_stage stage) {this->stage = stage; vld = false;}
	virtual ~stageInfo() : vld(false) {}
	/**
...
//	inline ThreadID get_tid() { return this->Tid;}
	...
	inline pipe_stage get_info_stage(){ return this->stage;}
